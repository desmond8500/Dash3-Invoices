...
@Component({
    selector: 'app-charts-apex-radar',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-radar.component.html',
    styleUrl: './charts-apex-radar.component.scss'
})
export class ChartsApexRadarComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicRadarChart('["--in-success"]');
    this._multipleSeriesChart('["--in-danger", "--in-success", "--in-primary"]');
    this._polygonFillChart('["--in-info"]');
