...
@Component({
    selector: 'app-charts-apex-treemap',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-treemap.component.html',
    styleUrl: './charts-apex-treemap.component.scss'
})
export class ChartsApexTreemapComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._differentColorChart('["--in-success"]');
    this._MultiDimensionalChart('["--in-primary","--in-success"]');
    this._distributedTreemapChart('["--in-primary", "--in-secondary", "--in-success", "--in-info","--in-warning", "--in-danger"]');
    this._colorRangesChart('["--in-info","--in-danger"]');
  }
