...
@Component({
    selector: 'app-charts-apex-column',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-column.component.html',
    styleUrl: './charts-apex-column.component.scss'
})
export class ApexColumnComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicChart('["--in-danger", "--in-primary", "--in-success"]');
    this._columnWithDataChart('["--in-success"]');
    this._StackedColumnChart('["--in-primary", "--in-success", "--in-warning", "--in-danger"]');
    this._StackedColumn100Chart('["--in-primary", "--in-success", "--in-warning"]');
    this._ColumnWithMarkerChart('["--in-success", "--in-primary"]');
    this._ColumnWithRotatedChart('["--in-info"]');
    this._ColumnWithNagetiveChart('["--in-success", "--in-danger", "--in-warning"]');
    this._rangeColumnChart('["--in-primary", "--in-success"]');
    this._dynamicQuarterLoadedChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-dark", "--in-info"]');
    this._dynamicLoadedChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-dark", "--in-info"]');
    this._distributedColumnChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-dark", "--in-info"]')
    this._groupLabelChart('["--in-info"]')
  }
