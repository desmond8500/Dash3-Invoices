...
@Component({
    selector: 'app-charts-apex-candlestick',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-candlestick.component.html',
    styleUrl: './charts-apex-candlestick.component.scss'
})
export class ChartsApexCandlestickComponent {// bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicCandlestickChart('["--in-success", "--in-danger"]');
    this._chartCandleOptions('["--in-info", "--in-danger"]');
    this._chartBarOptions('["--in-warning", "--in-danger"]');
    this._categoryXAxisChart('["--in-success", "--in-danger"]');
    this._candlestickLineChart('["--in-success", "--in-danger", "--in-info", "--in-warning"]');
  }
