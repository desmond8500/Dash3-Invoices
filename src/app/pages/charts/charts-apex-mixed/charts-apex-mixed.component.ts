...
@Component({
    selector: 'app-charts-apex-mixed',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-mixed.component.html',
    styleUrl: './charts-apex-mixed.component.scss'
})
export class ChartsApexMixedComponent {
...
ngOnInit(): void {
  ...
  */
  ...
  this._lineChart('["--in-primary", "--in-success"]');
  this._multipleYAxisChart('["--in-primary", "--in-info", "--in-success"]');
  this._lineAreaChart('["--in-primary", "--in-success"]');
  this._lineColumnAreaChart('["--in-primary", "--in-success", "--in-danger"]');
}
