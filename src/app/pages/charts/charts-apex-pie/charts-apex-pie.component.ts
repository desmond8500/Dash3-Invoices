...
@Component({
    selector: 'app-charts-apex-pie',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-pie.component.html',
    styleUrl: './charts-apex-pie.component.scss'
})
export class ChartsApexPieComponent {
  // bread crumb items
   ...
   */
   ...
   this._simplePieChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info"]');
   this._simpleDonutChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info"]');
   this._updatingDonutChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info"]');
   this._monochromePieChart('["--in-primary"]');
   this._gradientDonutChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info"]');
   this._patternedDonutChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info"]');
   this._pieWithImageChart('["--in-primary", "--in-success", "--in-warning", "--in-info"]');
  }
