...
@Component({
    selector: 'app-charts-apex-scatter',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-scatter.component.html',
    styleUrl: './charts-apex-scatter.component.scss'
})
export class ChartsApexScatterComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicScatterChart('["--in-primary", "--in-success", "--in-warning"]');
    this._dateTimeScatterChart('["--in-primary", "--in-success", "--in-warning", "--in-warning", "--in-info"]');
    this._ScatterImagesChart('["--in-primary", "--in-danger"]');
  }
