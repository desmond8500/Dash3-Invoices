...
@Component({
    selector: 'app-charts-apex-radialbar',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-radialbar.component.html',
    styleUrl: './charts-apex-radialbar.component.scss'
})
export class ChartsApexRadialbarComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicRadialbarChart('["--in-success"]');
    this._multipleRadialbarChart('["--in-primary", "--in-success", "--in-warning", "--in-danger"]');
    this._customAngleChart('["--in-primary", "--in-info", "--in-danger", "--in-success"]');
    this._gradientCircleChart('["--in-success"]');
    this._strokedCircleChart('["--in-success"]');
    this._radialbarsChart('["--in-success"]');
    this._semiCircleChart('["--in-primary"]');
  }
