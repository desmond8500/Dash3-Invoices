...
@Component({
    selector: 'app-charts-apex-bubble',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-bubble.component.html',
    styleUrl: './charts-apex-bubble.component.scss'
})
export class ChartsApexBubbleComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._simpleBubbleChart('["--in-primary", "--in-info", "--in-warning", "--in-success"]');
    this._BubbleChart('["--in-primary", "--in-success", "--in-warning", "--in-danger"]');
