...
@Component({
    ...
    styleUrl: './apex-area.component.scss'
})
export class ApexAreaComponent {
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicAreaChart('["--in-success"]');
    this._splineAreaChart('["--in-primary", "--in-secondary"]');
    this._datetimeXaxisChart('["--in-info"]');
    this._nagativeValueChart('["--in-success", "--in-info"]');
    this._githubmMonthAreaChart('["--in-danger"]');
    this._githubmYearAreaChart('["--in-success"]');
    this._stackedAreaChart('["--in-success", "--in-info", "--in-light"]');
    this._irregularTimeseriesChart('["--in-primary", "--in-warning", "--in-success"]');
    this._nullValuesAreaChart('["--in-success"]');
  }
