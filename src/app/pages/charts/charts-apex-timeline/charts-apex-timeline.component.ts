...
@Component({
    selector: 'app-charts-apex-timeline',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-timeline.component.html',
    styleUrl: './charts-apex-timeline.component.scss'
})
export class ChartsApexTimelineComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicTimelineChart('["--in-primary"]');
    this._differentColorChart('["--in-primary", "--in-danger", "--in-success", "--in-warning", "--in-info"]');
    this._multiSeriesTimelineChart('["--in-primary","--in-success"]');
    this._advancedTimelineChart('["--in-primary", "--in-success", "--in-warning"]');
    this._multipleSeriesChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info","--in-gray","--in-pink","--in-purple","--in-secondary", "--in-dark"]');
  }
