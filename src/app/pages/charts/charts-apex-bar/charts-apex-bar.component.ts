...
@Component({
    selector: 'app-charts-apex-bar',
    imports: [NgApexchartsModule, PageTitleComponent],
    templateUrl: './charts-apex-bar.component.html',
    styleUrl: './charts-apex-bar.component.scss'
})
export class ChartsApexBarComponent {
  // bread crumb items
  ...
  ngOnInit(): void {
    ...
    */
    ...
    this._basicBarChart('["--in-success"]');
    this._customDataLabelsChart('["--in-primary", "--in-secondary", "--in-success", "--in-info", "--in-warning", "--in-danger", "--in-dark", "--in-primary", "--in-success", "--in-secondary"]');
    this._stackedBarChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info"]');
    this._stacked100BarChart('["--in-primary", "--in-success", "--in-warning", "--in-danger", "--in-info"]');
    this._barWithNegativeChart('["--in-primary", "--in-success"]');
    this._barWithMarkersChart('["--in-success", "--in-primary"]');
    this._reversedBarChart('["--in-info"]');
    this._patternedChart('["--in-primary", "--in-success", "--in-warning", "--in-danger"]');
    this._groupedBarChart('["--in-primary", "--in-success"]');
    this._barWithImageChart('["--in-success"]');
  }
