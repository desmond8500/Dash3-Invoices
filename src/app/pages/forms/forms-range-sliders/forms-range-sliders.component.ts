...
@Component({
    selector: 'app-forms-range-sliders',
    imports: [PageTitleComponent, NgxSliderModule],
    templateUrl: './forms-range-sliders.component.html',
    styleUrl: './forms-range-sliders.component.scss'
})
export class FormsRangeSlidersComponent {
